                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <label class="block text-sm">
                            ...
                            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Name" type="text" name="name" value="{{ old('name') }}" required />
                        </label>
                        @error('name')
                    ...
                    <div>
                        <label class="block mt-4 text-sm">
                            ...
                            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Confirm Password" type="password" name="password_confirmation" required />
                        </label>
                        @error('password')
                            <label class="text-error text-xs">{{ $message }}</label>
                        @enderror
